...
export function generateMetadata({ params }: { params: { category: string } }): Metadata {
  ...
  if (collection) {
    return {
      ...
      title: `${collection.name.startsWith('AFZOX') ? '' : 'AFZOX '}${collection.name}`,
  ...
  return {
    title: cat.name,
    description: `${cat.desc} Browse ${cat.name.toLowerCase()} from the ${parent ? brandName(parent.name) : 'AFZOX'} collection, manufactured and installed across India.`,
