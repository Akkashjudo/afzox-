...
export const metadata: Metadata = {
  ...
  description: `Browse AFZOX commercial gym machines across the ${COLLECTIONS.map((c) => c.name).join(', ')} collections — plate loaded, pin loaded, benches, racks, cable stations and storage. Filter, search and enquire on WhatsApp.`,
